...
Note, that in the real algorithm, they choose to use the psuedoinverse denoted $$\Sigma^\dagger$$ to deal with invertibility challenges. It is important that the 
